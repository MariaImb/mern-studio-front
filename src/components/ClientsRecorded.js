...
import './ClientsRecorded.css';

const ClientsRecorded = () => {
    return(
        <div>            
            ...
            <div className="separador-flecha" >
            </div>
                    ...
                    <div className="row row-cards">
                        <div className="col-md-5 col-sm-10 card clientes-card">
                            <div className="card-body">                          
                                <h5 className="card-title">OLIVER 4 - INVISIBLE</h5>
                                <iframe width="100%" height="315" src="https://www.youtube.com/embed/Ds-OlCmmWrs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>                
                        </div>
                        <div className="col-md-5 col-sm-10 card clientes-card">
                            <div className="card-body">
                                
                                <h5 className="card-title">CUATRO CUARTOS - ACEPTAR</h5>
                                <iframe width="100%" height="315" src="https://www.youtube.com/embed/hr-tJYCE-Zg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    ...
                    <div className="row row-cards">
                        <div className="col-md-5 col-sm-10 card clientes-card">                        
                            <div className="card-body">
                                ...
                                <h5 className="card-title">OLIVER 4 - ACLARECER</h5>
                                <iframe width="100%" height="315" src="https://www.youtube.com/embed/hsdFum098t8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            ...
            <div className="clientes-title">
                <h1>THE MEBRITS</h1> 
                <p>Conoce nuestro proyecto de covers grabados en el estudio</p>
                <div className="separador-flecha" >
                </div>
            </div>
...
export default ClientsRecorded